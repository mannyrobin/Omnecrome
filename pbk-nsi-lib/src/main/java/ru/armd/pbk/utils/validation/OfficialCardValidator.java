...
/**
 * Реализация аннотации проверки СКК.
 */
public class OfficialCardValidator
	extends BaseValidator
	implements
	ConstraintValidator<IOfficialCardValidator, OfficialCardDTO> {

   @Autowired
   private OfficialCardMapper mapper;

   @Override
   public void initialize(IOfficialCardValidator constraintAnnotation) {

   }

   @Override
   public boolean isValid(OfficialCardDTO value,
