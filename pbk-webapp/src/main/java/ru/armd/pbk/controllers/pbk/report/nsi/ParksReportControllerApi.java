...
import ru.armd.pbk.services.aspose.nsi.ParkReportService;

/**
 * Контроллер для генерации отчетов парков.
 */
@Controller
@RequestMapping(ParksReportControllerApi.RM_CONTROLLER_PATH)
public class ParksReportControllerApi
	extends BaseReportControllerApi {

   public static final String RM_PATH = "/reports/aspose/nsi/parks";
   public static final String RM_CONTROLLER_PATH = RM_API_PATH + RM_PATH;

   @Autowired
   ParksReportControllerApi(ParkReportService reportService) {
	  super(reportService);
   }
