angular.module('armada')
	.controller('PuskOwnersHistoryCtrl', ['$scope', 'PusksService', 'GridService', '$state', '$stateParams',
		function ($scope, PusksService, GridService, $state, $stateParams) {
			...
			$scope.gridScope.grid = GridService.initGridData({
				...
				gridName: $state.current.name + ".puskOwnersHistoryGrid",
