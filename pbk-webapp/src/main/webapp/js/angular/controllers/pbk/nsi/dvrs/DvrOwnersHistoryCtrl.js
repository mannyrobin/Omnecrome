angular.module('armada')
	.controller('DvrOwnersHistoryCtrl', ['$scope', 'DvrsService', 'GridService', '$state', '$stateParams',
		function ($scope, DvrsService, GridService, $state, $stateParams) {
			...
			$scope.gridScope.grid = GridService.initGridData({
				...
				gridName: $state.current.name + ".dvrOwnersHistoryGrid",
