angular.module('armada')
	.controller('ContractlessCardOwnersHistoryCtrl', ['$scope', 'ContactlessCardsService', 'GridService', '$state', '$stateParams',
		function ($scope, ContactlessCardsService, GridService, $state, $stateParams) {
			...
			$scope.gridScope.grid = GridService.initGridData({
				...
				gridName: $state.current.name + ".ccOwnersHistoryGrid",
