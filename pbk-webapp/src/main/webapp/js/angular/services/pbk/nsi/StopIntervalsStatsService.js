angular.module('armada')
	.service('StopIntervalsStatsService', ['UrlService', 'BaseItemService', 'Restangular', 'GridService', function (UrlService, BaseItemService, Restangular, GridService) {
		var baseUrl = UrlService.getApiPrefix() + 'nsi/stop-intervals-stats';
		...
		service.getStopSelectList = function (filters) {
			return Restangular.one(baseUrl + '/stops-slist').get(
				GridService.getFilterParams(filters));
		}
