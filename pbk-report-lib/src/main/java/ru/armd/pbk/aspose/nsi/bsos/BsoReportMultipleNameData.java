...
/**
 * Класс, предназначенный для построения имени файла итогового множественного отчёта по акту об изъятии.
 */
public class BsoReportMultipleNameData
	...
	*/
   public BsoReportMultipleNameData(Date reportDateTime, List<String> bsoNumbers) {
